...
# CSV
if False:
    csv_df = pd.read_csv('data/BoardingData.csv', sep=';')
    #print(csv_df)
    #print(csv_df[['PassengerFirstName', 'PassengerSecondName']].head(3))
...
# YAML
if False:
    with open('data/SkyTeam-Exchange.yaml', 'r') as file:
        data = yaml.safe_load(file)
        yaml_df = pd.DataFrame(data)
        print(yaml_df.head())
